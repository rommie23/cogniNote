// This is today screen which show all records of today which we can edit and delete ///////
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _editButton(JournalEntry entry) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: const Row(
          children: [
            Icon(Icons.edit, size: 18, color: Color(0xFF5a189a)),
            SizedBox(width: 6),
            Text(
              'Edit',
              style: TextStyle(
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: const Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.delete, size: 18, color: Color(0xFFb22222)),
              SizedBox(width: 6),
              Text(
                'Delete',
                style: TextStyle(

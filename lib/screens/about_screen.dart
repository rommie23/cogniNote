...
class _AboutScreenState extends State<AboutScreen> {
  ...
  final List<Map<String, String>> _sections = [
    ...
    },
    {
      ...
      "title": "Contact & Support",
      "content":
          "If you need help, report a bug, or want to request a feature, contact us at rohitthakur023@gmail.com. We aim to respond within a few business days.",
    },
  ];
        ...
        children: [
          Material(
            ...
            borderRadius: BorderRadius.only(
              ...
              bottomLeft: isOpen ? Radius.zero : const Radius.circular(12),
              bottomRight: isOpen ? Radius.zero : const Radius.circular(12),
            ),
            child: InkWell(
              onTap: () => _toggleSection(section['id']!),
              borderRadius: BorderRadius.only(
